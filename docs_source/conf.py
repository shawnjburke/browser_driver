...
htmlhelp_basename = 'BrowserDriverdoc'
...
latex_documents = [
    (master_doc, 'BrowserDriver.tex', 'Browser Driver Documentation',
...
man_pages = [
    (master_doc, 'browserdriver', 'Browser Driver Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'BrowserDriver', 'Browser Driver Documentation',
     author, 'BrowserDriver', 'One line description of project.',
     'Miscellaneous'),
]
